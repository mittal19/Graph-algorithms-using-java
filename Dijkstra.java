...
{ 
    ...
    { 
        ...
        System.out.println("dist"+"  "+distance[0]+"  "+distance[2]+"  "+distance[4]);
        ...
        { 
            ...
            System.out.println(nextNode+"next & min"+min);
            visited[nextNode] = 1;
            for (int i=0;i<5;i++) 
            { 
                if (visited[i]!=1) 
                { 
                    System.out.println("iin"+i);
                    System.out.println("sum"+min+matrix[nextNode][i]);
                    if (min+matrix[nextNode][i] < distance[i]) 
                    { 
                        System.out.println("iiin"+i);
                        distance[i] = min+matrix[nextNode][i]; 
                        preD[i] = nextNode; 
                    } 

                } 
                System.out.println(distance[i]+"dist&pred"+preD[i]);
            } 
        } 
